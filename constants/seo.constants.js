export const SITE_NAME = 'RBAND';
export const SITE_DOMAIN = 'http://localhost:3000';
// export const API_DOMAIN = 'https://rbb.rband.pro';
export const API_DOMAIN = 'http://rband-backend.rbnd';
...
export const API_USERNAME = 'Default';
